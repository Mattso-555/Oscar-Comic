...
const KIT = [
  { name: 'Cloud', emoji: '☁️', hint: 'A puffy cloud — big bumpy bumps!' },
  { name: 'Sun', emoji: '☀️', hint: 'A sun with rays shooting out!' },
  { name: 'Tree', emoji: '🌳', hint: 'A trunk with a big leafy top!' },
  { name: 'Star', emoji: '⭐', hint: 'A star — spiky or wonky is perfect!' },
  { name: 'Rock', emoji: '🪨', hint: 'A rock, a bush, or a little hill!' },
  { name: 'Flower', emoji: '🌸', hint: 'A flower with happy petals!' },
];
