        ...
        for (const it of cast) {
          ...
          if (it.tag === 'character') {
            ...
            p.objs.push({
              ...
              x: left ? 6 + chars * 3 : 52, y: 30 + chars * 4,
              w: 44, flip: !left, fx: false,
            });
            chars++; placed++;
          } else if (it.tag === 'prop') {
            p.objs.push({ id: nid(), src: it.dataUrl, x: 38, y: 56, w: 28, flip: false, fx: false });
            placed++;
          } else {
